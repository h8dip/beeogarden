...
<head>
  ...
  <title>Beeogarden Admin- Registar</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6"><img src="img/happy_bee.jpg" style="height:553px;width:auto;overflow:hidden;"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center"> <i class="fab fa-forumbee"></i><p>beeogarden</p></div>
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Bem vindo!</h1>
                  </div>
                  <form class="user" method="post" action="scripts/registo.php">
